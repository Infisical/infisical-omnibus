...
# omnibus-infisical package, then Chef will incorrectly attempt to use it, and can
# potentially fail as seen from
# https://infisical.com/infisical-org/omnibus-infisical/-/issues/7741. Hence, we need to
# bundle libarchive in the package.
dependency 'libarchive'
dependency 'rubygems'

build do
  gemfile_dir = "#{install_dir}/embedded/service/omnibus-infisical"

  mkdir gemfile_dir
  gemfile = File.join(Omnibus::Config.project_root, 'config/templates/omnibus-infisical-gems/Gemfile')
